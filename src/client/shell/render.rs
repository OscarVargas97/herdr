...
pub(super) struct ShellRenderState<'a> {
    ...
    pub(super) repos: &'a [crate::api::schema::RepoInfo],
    pub(super) collapsed_repo_groups: &'a HashSet<String>,
    pub(super) repo_scroll: &'a mut usize,
    pub(super) ports: &'a [crate::api::schema::PortInfo],
    pub(super) port_forwards: &'a super::ports::PortForwards,
